...
public class ManageProductDto {
    ...
    @Builder
    public ManageProductDto(Long id, String email, String barcode, String product_type, String itemName, String itemExp, Integer itemAmount, String itemReg, Integer remain_date){
        this.id=id;
        this.email=email;
