...
public class ManageProductEntity {
    ...
    @Builder
    public ManageProductEntity(Long id, String email, String barcode, String itemName, String product_type, String itemExp, String itemReg, Integer itemAmount, Integer itemRemainingDate){
        this.id = id;
        this.email=email;
